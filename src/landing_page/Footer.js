...
function Footer() {
  return (
    <footer style={{ backgroundColor: "#fbfbfa" }}>
      <div className="container border-top mt-5">
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          ...
          <p>
            Zerodha Broking Limited: Customers availing fixed deposit
            facilitation services offered by Blostem Fintech Private Limited
            will not have access to any exchange investor grievance redressal
            forum, SEBI SCORES/ODR, conciliation, or arbitration mechanism in
            respect of such fixed deposit products.
          </p>
